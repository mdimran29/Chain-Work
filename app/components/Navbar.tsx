    ...
    <nav className="fixed top-0 w-full z-50 bg-slate-900/60 backdrop-blur-xl border-b border-white/10 flex items-center justify-between px-6 py-3 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {walletConnected ? (
            <Link href="/dashboard/freelancer" className="bg-surface-container-high text-primary px-5 py-2 rounded-xl font-mono text-sm border border-primary/20 hover:bg-surface-container-highest transition-all cursor-pointer">
              0x71C...8e4f
            </Link>
          ) : (
            <button 
