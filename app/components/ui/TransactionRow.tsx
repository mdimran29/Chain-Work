    ...
    <tr className="hover:bg-white/5 transition-all group">
      <td className="px-6 py-5">
        <div className="flex items-center gap-3">
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${iconBgColors}`}>
      ...
      <td className="px-6 py-5">
        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${statusColors}`}>
          {status}
        </span>
      </td>
      <td className="px-6 py-5">
        <a className="font-mono text-xs text-indigo-400 hover:text-indigo-300 hover:underline flex items-center gap-1" href="#">
          {hash}
