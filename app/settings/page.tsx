      ...
      <main className="md:ml-64 pt-24 pb-12 px-4 md:px-12 bg-background min-h-screen">
        <div className="max-w-5xl mx-auto">
          <header className="mb-12">
            <h1 className="text-4xl font-black tracking-tight mb-2 text-white">The Curator's Command</h1>
            <p className="text-on-surface-variant text-lg">Adjust your presence in the digital ether.</p>
          </header>
            ...
            <div className="lg:col-span-9 space-y-10">
              ...
              <section className="bg-surface-container/60 backdrop-blur-xl border border-primary/5 p-8 rounded-2xl">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <button className="text-indigo-400 text-sm font-bold hover:underline">+ Link New Wallet</button>
                </div>
                  ...
                  <div className="flex items-center justify-between p-5 rounded-2xl bg-surface-container-lowest border border-white/5">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center">
                        <span className="material-symbols-outlined text-blue-400" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
                      </div>
                      <div>
                        <p className="font-mono text-sm text-white">0x71C...4f21</p>
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">MetaMask</span>
                          <span className="px-1.5 py-0.5 rounded text-[10px] bg-tertiary/10 text-tertiary font-bold">PRIMARY</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <p className="font-mono text-indigo-300 font-bold">2.45 ETH</p>
                      <button className="p-2 hover:bg-white/5 rounded-lg text-error transition-all" title="Unlink Wallet">
                        <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>link_off</span>
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-5 rounded-2xl bg-surface-container-lowest border border-white/5 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center">
                        <span className="material-symbols-outlined text-purple-400" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
                      </div>
                      <div>
                        <p className="font-mono text-sm text-white">0x99a...e210</p>
                        <span className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest block mt-1">Phantom (Solana)</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
              ...
              <div className="flex items-center justify-end gap-4 pb-12">
                <button className="px-8 py-3 rounded-xl font-bold text-on-surface-variant hover:text-white transition-all">Discard Changes</button>
                <button onClick={handleSave} className="px-10 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-black shadow-lg shadow-indigo-500/20 hover:scale-[1.02] active:scale-95 transition-all">Save Curator Identity</button>
              </div>
            </div>
          </div>
        </div>
