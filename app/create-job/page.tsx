      ...
      <div className="lg:col-span-7 space-y-12">
        <header>
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">
            Forge a new <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary-container">Job Contract</span>
          </h1>
          <p className="text-on-surface-variant text-lg">Define your requirements and deploy them to the global talent network.</p>
        </header>
        ...
        <section className="space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-primary-container/20 text-primary font-mono text-sm border border-primary/20">01</span>
              ...
              <div className="group">
                ...
                <div className="bg-surface-container-low rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                  <div className="flex gap-4 p-3 border-b border-outline-variant/10 bg-surface-container/50">
                    ...
                    <button className="material-symbols-outlined text-outline hover:text-on-surface cursor-pointer">format_italic</button>
                    <button className="material-symbols-outlined text-outline hover:text-on-surface cursor-pointer">list</button>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-primary-container/20 text-primary font-mono text-sm border border-primary/20">02</span>
          ...
          <div className="pt-8">
            ...
            <p className="text-center text-xs text-outline mt-4 font-mono uppercase tracking-widest">Transaction fee: 0.002 SOL</p>
          </div>
        </section>
      </div>
        ...
        <div className="bg-surface-container-high/60 backdrop-blur-xl p-8 rounded-2xl border border-white/5 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex justify-between items-start mb-8">
              <span className="px-3 py-1 bg-tertiary/10 text-tertiary text-[10px] font-bold uppercase tracking-widest rounded-full border border-tertiary/20">Preview Mode</span>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 flex flex-wrap gap-2">
                <span className="text-[10px] font-semibold px-2 py-1 rounded bg-secondary-container/20 text-on-secondary-container">Rust</span>
                <span className="text-[10px] font-semibold px-2 py-1 rounded bg-secondary-container/20 text-on-secondary-container">Solana</span>
                <span className="text-[10px] font-semibold px-2 py-1 rounded bg-secondary-container/20 text-on-secondary-container">Security Audit</span>
              </div>
            </div>
          </div>
          <div className="mt-10 pt-6 border-t border-white/5 flex items-center gap-4 text-outline">
            <span className="material-symbols-outlined text-lg">info</span>
            <p className="text-[11px] leading-tight">This is how your job will appear to applicants. You can edit this information at any time before deploying the smart contract.</p>
          </div>
        </div>
