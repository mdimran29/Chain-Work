      ...
      <main className="lg:ml-64 pt-24 pb-12 px-6 md:px-10 min-h-screen bg-background text-on-surface">
        ...
        <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            <div className="bg-surface-container/60 backdrop-blur-xl flex items-center px-4 py-2 rounded-xl border border-white/5">
              <div className="mr-4">
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold">Total Volume</p>
            ...
            <div className="bg-surface-container/60 backdrop-blur-xl flex items-center px-4 py-2 rounded-xl border border-white/5">
              <div className="mr-4">
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold">Pending</p>
        ...
        <div className="mb-6 flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="flex gap-2 w-full md:w-auto overflow-x-auto no-scrollbar pb-2 md:pb-0">
            <button className="bg-indigo-500/10 text-indigo-300 px-4 py-2.5 rounded-lg border border-indigo-500/20 text-sm whitespace-nowrap font-medium">All Networks</button>
            <button className="bg-surface-container hover:bg-surface-container-high px-4 py-2.5 rounded-lg text-slate-400 text-sm whitespace-nowrap transition-colors">Ethereum</button>
            <button className="bg-surface-container hover:bg-surface-container-high px-4 py-2.5 rounded-lg text-slate-400 text-sm whitespace-nowrap transition-colors">Solana</button>
            <button className="bg-surface-container hover:bg-surface-container-high px-4 py-2.5 rounded-lg text-slate-400 text-sm whitespace-nowrap transition-colors">Polygon</button>
          </div>
        ...
        <div className="bg-surface-container/60 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/5 shadow-xl">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/5 border-b border-white/5">
                  <th className="px-6 py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Job Title</th>
                  <th className="px-6 py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Amount</th>
                  <th className="px-6 py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Network</th>
                  <th className="px-6 py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Status</th>
                  <th className="px-6 py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Transaction Hash</th>
          ...
          <div className="px-6 py-4 bg-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="w-8 h-8 rounded-lg bg-indigo-500 text-white font-bold text-xs">1</button>
              <button className="w-8 h-8 rounded-lg bg-surface-container flex items-center justify-center text-slate-400 hover:text-white transition-colors border border-white/5">2</button>
              <button className="w-8 h-8 rounded-lg bg-surface-container flex items-center justify-center text-slate-400 hover:text-white transition-colors border border-white/5">3</button>
              <button className="w-8 h-8 rounded-lg bg-surface-container flex items-center justify-center text-slate-400 hover:text-white transition-colors border border-white/5">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container/60 backdrop-blur-xl p-6 rounded-2xl border border-white/5 md:col-span-2 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-slate-500 text-sm mb-6 max-w-md">Generate official tax-compliant reports for your digital earnings and gas expenses.</p>
