      ...
      <main className="lg:ml-64 mt-16 p-6 md:p-10 max-w-7xl mx-auto min-h-screen bg-background text-on-surface">
        ...
        <header className="mb-12">
          ...
          <p className="text-on-surface-variant text-lg">
            Verified chain-of-trust reviews and marketplace performance data.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="md:col-span-2 bg-surface-container/60 backdrop-blur-xl border border-primary/5 rounded-2xl p-8 flex items-center justify-between relative overflow-hidden group shadow-lg">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-end gap-3 flex-wrap">
                ...
                <div className="flex flex-col mb-1">
                  ...
                  <span className="text-on-surface-variant text-sm font-medium mt-1">
                    Based on 124 verified jobs
                  </span>
                </div>
              </div>
            </div>
            <div className="text-right relative z-10 hidden sm:block">
              <div className="mb-2">
                <span className="text-xs font-mono text-tertiary bg-tertiary/10 px-2 py-1 rounded border border-tertiary/20">
                  PLATINUM TIER
                </span>
              </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
          <div className="flex gap-2 w-full sm:w-auto overflow-x-auto no-scrollbar pb-2 sm:pb-0">
            <button className="bg-surface-container-highest text-white px-4 py-2 rounded-xl text-sm font-bold border border-white/5 whitespace-nowrap">
              All Reviews
            </button>
            <button className="bg-transparent text-on-surface-variant px-4 py-2 rounded-xl text-sm font-medium hover:bg-white/5 transition-all whitespace-nowrap">
              Latest
            </button>
            <button className="bg-transparent text-on-surface-variant px-4 py-2 rounded-xl text-sm font-medium hover:bg-white/5 transition-all whitespace-nowrap">
              Highest Rated
