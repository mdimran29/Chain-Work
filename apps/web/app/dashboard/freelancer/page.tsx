          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-on-surface-variant text-lg">
                Your Web3 professional ecosystem at a glance.
              </p>
            </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-surface-container-low p-8 rounded-2xl border border-outline-variant/10">
              ...
              <div className="mt-4 flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full border-2 border-surface bg-secondary/20 flex items-center justify-center text-[10px] font-bold">
                  OP
                </div>
                <div className="w-8 h-8 rounded-full border-2 border-surface bg-tertiary/20 flex items-center justify-center text-[10px] font-bold">
                  WS
                </div>
            ...
            <div className="bg-surface-container-low p-8 rounded-2xl border border-outline-variant/10">
              ...
              <p className="mt-2 text-xs text-on-surface-variant">
                Top 5% of applicants in Solidity
              </p>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-3 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button className="text-primary text-sm font-semibold hover:underline transition-all cursor-pointer">
                  View All
                </button>
              </div>
              <div className="space-y-4">
                ...
                <div className="bg-surface-container p-6 rounded-2xl border border-outline-variant/5 hover:border-primary/20 transition-all duration-300 group">
                  ...
                  <p className="text-on-surface-variant text-sm line-clamp-2 mb-4 leading-relaxed">
                    Reviewing complex DeFi logic across 12 smart contracts. Expertise in gas
                    optimization and reentrancy protection required...
                  </p>
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="px-3 py-1 bg-surface-container-highest text-primary text-[10px] font-bold rounded-lg uppercase tracking-wider">
                      Security
                    </span>
                    <span className="px-3 py-1 bg-surface-container-highest text-primary text-[10px] font-bold rounded-lg uppercase tracking-wider">
                      Auditing
                ...
                <div className="bg-surface-container p-6 rounded-2xl border border-outline-variant/5 hover:border-primary/20 transition-all duration-300 group">
                  ...
                  <p className="text-on-surface-variant text-sm line-clamp-2 mb-4 leading-relaxed">
                    Designing a high-fidelity interface for minting generative artworks. Focus on
                    dark mode aesthetics and real-time visualization...
                  </p>
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="px-3 py-1 bg-surface-container-highest text-primary text-[10px] font-bold rounded-lg uppercase tracking-wider">
                      Design
              ...
              <div className="bg-surface-container-low rounded-2xl overflow-hidden border border-outline-variant/5">
                ...
                <div className="divide-y divide-outline-variant/10">
                  ...
                  <div className="p-5 flex justify-between items-center hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="text-right space-y-1">
                      <span className="px-2 py-0.5 bg-tertiary/10 text-tertiary text-[10px] font-bold rounded-full border border-tertiary/20 uppercase">
                        Accepted
                      </span>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-on-surface-variant leading-relaxed">
                      Add a video introduction to reach the &quot;Elite&quot; tier and unlock lower
                      platform fees.
                    </p>
                  </div>
                </div>
