    ...
    <aside className="fixed left-0 top-[4.5rem] h-[calc(100vh-4.5rem)] w-64 bg-slate-900/50 backdrop-blur-lg border-r border-white/5 flex-col py-6 gap-2 font-sans text-sm font-medium z-40 hidden md:flex overflow-y-auto no-scrollbar">
      <div className="px-6 mb-8">
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className="w-8 h-8 rounded-lg bg-indigo-500 flex items-center justify-center cursor-pointer hover:bg-indigo-400 transition-colors"
          >
      ...
      <div className="px-4 py-6 space-y-1">
        <Link
          href="/help"
          className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-all rounded-xl"
        >
