    ...
    <>
        ...
        <aside className="w-72 fixed left-0 top-0 h-screen pt-24 pb-8 px-6 bg-[#121315] overflow-y-auto hidden lg:block no-scrollbar border-r border-white/5">
          <div className="space-y-8">
            ...
            <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10 mt-12">
              ...
              <Link
                href="/create-job"
                className="block text-center w-full mt-4 py-3 bg-surface-container-highest text-on-surface text-sm font-semibold rounded-xl hover:bg-surface-container-high transition-colors cursor-pointer"
              >
                Post a Job
              </Link>
            </div>
        ...
        <main className="flex-1 lg:ml-72 px-6 lg:px-12 pb-12">
          ...
          <header className="py-12">
            ...
            <p className="text-on-surface-variant max-w-xl text-lg">
              Browse verified Web3 opportunities and contribute to the future of decentralized
              infrastructure.
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
            ...
            <div className="group relative bg-[#1f2021] border border-white/5 rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300">
              ...
              <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                Design and implement core lending protocols for our upcoming L2 launch. Deep
                knowledge of gas optimization required.
              </p>
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="px-3 py-1 rounded-full bg-[#0d0e0f] text-[10px] font-bold text-outline border border-white/5 uppercase tracking-tighter">
                  Solidity
                </span>
                <span className="px-3 py-1 rounded-full bg-[#0d0e0f] text-[10px] font-bold text-outline border border-white/5 uppercase tracking-tighter">
                  DeFi
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                ...
                <Link
                  href="/job/123"
                  className="px-4 py-2 bg-primary/10 text-primary hover:bg-primary hover:text-[#1000a9] rounded-lg text-xs font-bold transition-all cursor-pointer"
                >
                  Apply Now
                </Link>
              </div>
            ...
            <div className="group relative bg-[#1f2021] border border-white/5 rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300">
              ...
              <h2 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                Rust Developer (Anchor)
              </h2>
              <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                Migration of current ERC-20 staking logic to Solana SPL using the Anchor framework.
            ...
            <div className="group relative bg-[#1f2021] border border-white/5 rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300">
              ...
              <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                Reimagining the yield farming experience for high-net-worth users. Focus on visual
                hierarchy and complex data.
              </p>
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="px-3 py-1 rounded-full bg-[#0d0e0f] text-[10px] font-bold text-outline border border-white/5 uppercase tracking-tighter">
                  Figma
            ...
            <div className="group relative bg-[#1f2021] border border-white/5 rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 md:col-span-2 2xl:col-span-1 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-on-surface-variant mb-6">
                  Executive role for a top-tier VC-backed DAO platform. Influence the roadmap for
                  thousands of governance participants.
                </p>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                  ...
                  <Link
                    href="/job/123"
                    className="inline-block text-center px-6 py-2 bg-gradient-to-r from-primary to-secondary-container text-on-primary-container rounded-lg text-xs font-bold shadow-lg shadow-primary/20 transition-all cursor-pointer"
                  >
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-surface-container/60 backdrop-blur-3xl border-t border-white/5 px-6 py-4 flex justify-between items-center z-50">
        ...
        <div className="flex flex-col items-center -mt-8 relative z-10">
          <Link
            href="/create-job"
            className="w-14 h-14 rounded-full bg-gradient-to-r from-primary to-secondary-container shadow-xl flex items-center justify-center text-white"
          >
      ...
      <Link
        href="/create-job"
        className="hidden lg:flex fixed bottom-8 right-8 w-16 h-16 rounded-2xl bg-gradient-to-r from-primary to-secondary-container shadow-2xl items-center justify-center text-white group hover:scale-110 transition-all z-40 cursor-pointer"
      >
