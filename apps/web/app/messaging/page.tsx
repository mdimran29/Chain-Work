        ...
        <section className="col-span-12 md:col-span-4 lg:col-span-3 border-r border-white/5 flex flex-col bg-surface-container-low/30 h-full overflow-y-auto no-scrollbar hidden md:flex">
          <div className="p-6">
            ...
            <div className="relative group">
              ...
              <input
                className="w-full bg-surface-container-lowest border-none rounded-xl py-3 pl-10 pr-4 text-sm text-on-surface focus:ring-1 focus:ring-primary/20 placeholder:text-slate-600 transition-all"
          ...
          <div className="flex-1 px-2 pb-6 space-y-1">
            ...
            <button className="w-full flex items-center gap-4 p-4 rounded-2xl bg-surface-container-high transition-all border border-white/5 text-left relative overflow-hidden group">
              ...
              <div className="relative w-12 h-12 rounded-xl overflow-hidden flex-shrink-0">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuD5OqUm9uXWd1X0HREFZ-gQP4x5c__SkN1pl5Fm1_DOvMfSClJ5nLlYYHu2qOGHVx1eat4KEOo4sAPCM-HRkaALVQxKYHZm69PBoG1nk8Mr_rK58aGdKOacAWN2I1TuIwKm_acddohbkGcNF1VING4uEMb4_WPh_BDrSRLkrmb1C4W5B6cO08SNTOjLI3KryXiYGVW0pmfsxARuPSPDdyUcy-wdWpWQPwZ_4KFCibttoo017EKL3uh5tiiwWBx0uCLrlr6eRmLyfwk"
                  alt="Avatar"
                />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="text-primary text-[11px] font-bold uppercase tracking-wider mb-1">
                  dApp UX Redesign
                </div>
                <p className="text-slate-400 text-xs truncate">
                  The smart contract hooks are ready for the...
                </p>
              </div>
            ...
            <button className="w-full flex items-center gap-4 p-4 rounded-2xl hover:bg-white/5 transition-all text-left group">
              <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0">
                <img
                  className="w-full h-full object-cover"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCM1THVH5sPEKFc3iiuFJZ1g2AcmOI5LfnCMQXvZlw21w52Q9KaL1jB0nig_L7GRF5uJzy2vcAUjLX92l8KDPw48PS1WJh36zDx5QXcrR5RT4fLKm6KJ1Acp3fqi7eGUebR37jS61jIns-baZuo6SiybK6m7hyH5PH6BGzYgSU7FJd7E199MkqxikWr48EqV6-xillGUPAcYglj4-C_wMYy3OCdCjIJYaBXP4nQhESWJmQM8k_1RKRh_vaaswRSnwpUdaFd8y8dkds"
                  alt="Avatar"
                />
              </div>
              <div className="flex-1 min-w-0">
        ...
        <section className="col-span-12 md:col-span-8 lg:col-span-9 flex flex-col bg-surface relative h-full">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="w-10 h-10 rounded-xl overflow-hidden">
                  <img
                    className="w-full h-full object-cover"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlxv4EBU3kVkNtcTnmE8QI7ZfpjzaWzVsK0t-MeYLJlVTK1Bljtd86ws5qLE3XuulRDOcIF6rHADF4i3NHpROGam-C1usL5vkjvAXLqFEUCQtOhfoILTT9BqchkCvA-LGxY1yUL1YLmsVtjBISYsXLvNW5xHqn2JJiAqTMEkaUWurBG4RZGPIfiLfGHS0V6XmGrK28sPi6qESp2xPbK7VXXiQDr9TYQM_KYQnixh6lc4gFnm034UDmhB3-jLexp4CqHVYYt4PyKuc"
                    alt="Avatar"
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono text-indigo-400 bg-indigo-500/10 px-2 rounded-md">
                    dApp UX Redesign
                  </span>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 scroll-smooth no-scrollbar">
            ...
            <div className="flex justify-center">
              <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-slate-600 bg-surface-container-low px-4 py-1 rounded-full">
                July 24, 2024
              </span>
            </div>
          ...
          <footer className="p-6 bg-surface-container-lowest/80 backdrop-blur-xl border-t border-white/5 relative z-10 flex-shrink-0">
            <div className="max-w-4xl mx-auto flex items-end gap-3">
              ...
              <div className="flex-1 relative">
                <textarea
                  className="w-full bg-surface-container-high border-none rounded-2xl py-3.5 px-6 text-sm text-on-surface focus:ring-1 focus:ring-primary/20 placeholder:text-slate-600 resize-none transition-all no-scrollbar"
