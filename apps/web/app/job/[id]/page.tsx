        ...
        <div className="xl:col-span-8 space-y-8">
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              <span className="bg-tertiary/10 text-tertiary text-[10px] font-mono px-2 py-1 rounded-full uppercase tracking-widest font-bold">
                Open for Proposals
              </span>
            </div>
          ...
          <div className="flex flex-wrap gap-2">
            <span className="px-3 py-1.5 rounded-full bg-surface-container-highest text-primary-fixed-dim text-xs font-semibold border border-outline-variant/20">
              Solana
            </span>
            <span className="px-3 py-1.5 rounded-full bg-surface-container-highest text-primary-fixed-dim text-xs font-semibold border border-outline-variant/20">
              Rust
          ...
          <section className="prose prose-invert max-w-none space-y-6">
            <p className="text-on-surface-variant text-lg leading-relaxed">
              We are looking for a senior-level Fullstack Rust developer with deep expertise in the
              Solana ecosystem. You will be responsible for architecting and implementing
              high-performance programs (smart contracts) using Anchor and building the
              corresponding frontend interfaces.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-surface-container rounded-2xl p-5 border border-outline-variant/5 hover:border-primary/20 transition-all group cursor-pointer">
                ...
                <p className="text-xs text-on-surface-variant mb-4 line-clamp-2">
                  5+ years Rust experience. Lead dev at XYZ Protocol...
                </p>
                <div className="flex items-center justify-between">
              ...
              <div className="bg-surface-container rounded-2xl p-5 border border-outline-variant/5 hover:border-primary/20 transition-all group cursor-pointer">
                ...
                <p className="text-xs text-on-surface-variant mb-4 line-clamp-2">
                  Contributed to Solana Core. Expert in parallelization...
                </p>
                <div className="flex items-center justify-between">
              ...
              <div className="bg-surface-container rounded-2xl p-5 border border-outline-variant/5 hover:border-primary/20 transition-all group cursor-pointer">
                <div className="flex items-center gap-3 mb-4">
                  <img
                    alt="Candidate 3"
                    className="w-12 h-12 rounded-xl object-cover"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAfh0LXJTUFQp3Fp3JyCtxEG7LD8Oxl8CvfcPwpPgL_y5mwDrB-mNuxGQWzJCWgSih4kGK3HsrA8rYY2kunS_tWxGv8R7kC_M_rXuO6_eZMP985nja2-Aa3mbgwbfKlsMp3BSxZDfJM7h2qg_TgJgX6dgjyaxW6qoYbbrkzAZaOlTCBE8XYDk84w-CErOuz-AHHDUoP0TYuhGd0dt--VKqfNMPFhUsY16584rZzxuy9nX29nMUR_mKmRhcpbt4zg2_h7NgTqlRN5d0"
                  />
                  <div>
                ...
                <p className="text-xs text-on-surface-variant mb-4 line-clamp-2">
                  Fullstack master. React + Rust combo for 3 years...
                </p>
                <div className="flex items-center justify-between">
          ...
          <div className="glass-panel p-8 rounded-2xl border border-outline-variant/10 shadow-2xl space-y-8 bg-surface-container/60 backdrop-blur-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 bg-[#14F195]/10 px-3 py-1 rounded-full border border-[#14F195]/20">
                ...
                <span className="text-[10px] font-bold text-[#14F195] uppercase tracking-widest">
                  Solana
                </span>
              </div>
            </div>
            ...
            <div className="pt-4 space-y-4">
              <div className="flex flex-col gap-1">
                ...
                <a className="font-mono text-xs text-primary hover:underline truncate" href="#">
                  0xabc71c8e4f1234567890abcdef1234567890def
                </a>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-[10px] uppercase font-bold text-outline tracking-widest">
        ...
        <div className="w-80 glass-panel bg-surface-container/80 backdrop-blur-3xl rounded-2xl border border-outline-variant/20 shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="h-48 overflow-y-auto p-4 space-y-3">
            <div className="flex flex-col items-start gap-1">
              <div className="bg-surface-container-highest p-3 rounded-2xl rounded-tl-none text-xs text-on-surface-variant max-w-[85%]">
                Hey! I just submitted the code for the first milestone on GitHub. Can you take a
                look?
              </div>
          ...
          <div className="p-3 border-t border-outline-variant/10">
            <div className="relative flex items-center">
              <input
                className="w-full bg-surface-container-lowest border-none text-xs py-2.5 pl-4 pr-10 rounded-xl focus:ring-1 focus:ring-primary/30 outline-none"
                placeholder="Type a message..."
                type="text"
              />
              <button className="absolute right-2 material-symbols-outlined text-primary text-lg cursor-pointer">
                send
              </button>
            </div>
          </div>
